...
count=0;
% main loop
while count<120 % just run for 120 step for demo   
    ...
    data=str2num(char(command')); % tranform str to numerical matrix
    ...
    data1 = data(1); 
    data2 = data(2); 
    data3 = data(3); % sepearate each data in the matrix
